      ...
      <section className={styles.searchSection}>
        <Container className={`${styles.search} mx-2`}>
          <Container className={styles.formSelect}>
            <FormSelect className={styles.select} aria-label="Selecionar tipo de negociação" >
            ...
            <FormSelect className={styles.select} aria-label="Selecionar imóvel">
            ...
            <FormSelect className={styles.select} aria-label="Selecionar cidade">
            ...
            <FormSelect className={styles.select} aria-label="Selecionar bairro">
